...
public class FloatingActionButtonHelper {
    ...
    private static void animateOut(final FloatingActionButton button) {
    ...
    public static void setFloatingActionButtonVisibility(FloatingActionButton button, boolean isVisible) {
        if (button != null) {
            if (isVisible) {
                animateIn(button);
            } else {
