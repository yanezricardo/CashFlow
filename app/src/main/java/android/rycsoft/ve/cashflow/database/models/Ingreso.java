...
public class Ingreso {
	public static final String TABLE_NAME = "Ingreso";
	public static final String CONTENT_PATH = "Ingreso";
	public static final String AUTHORITY = "android.rycsoft.ve.cashflow.database.models.Ingreso";
	...
	public static void onUpgrade(SQLiteDatabase database, int oldVersion, int newVersion) {
		Log.w(Ingreso.class.getName(), "Upgrading database from version "
